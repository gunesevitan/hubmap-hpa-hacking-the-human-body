...
if __name__ == '__main__':
    ...
    dataset_path = settings.DATA / 'external_data' / 'CRAG'
    ...
    for image_filename in tqdm(image_filenames):
        ...
        mask_filename = str(dataset_path / 'masks' / f'{image_id}.png')
        ...
        # Multi-class labels are converted to binary labels because different glands are annotated as different labels
